...
export const PROJECTS: ProjectsType = {
  ...
  recipedia: {
    project: {
      ...
      background:
        "삼성전자의 패밀리허브 냉장고는, 큰 디스플레이를 활용한 레시피 추천 기능을 제공하고 있습니다. 하지만, 기존 레시피 추천 서비스는 DB에 저장된 레시피를 기반으로 추천하기 때문에, 레시피의 종류가 한정적이며 개인의 취향을 반영하지 못하는 문제가 많았습니다. 이러한 문제를 해결하기 위해, 고내의 재료 정보와 사용자가 입력한 재료를 기반으로 생성형 AI가 레시피를 추천하는 서비스를 기획하게 되었습니다.",
      logo: recipediaLogo,
  ...
  mailAt: {
    project: {
      ...
      background:
        "Outlook과 같은 이메일 서비스는 많은 기능을 제공하지만, 사용하기에 복잡하며 사내 정책에 따라 사용이 제한되는 경우가 많습니다. 이러한 문제를 해결하기 위해, 로컬 LLM 모델을 탑재한 그래프 기반의 관계형 메일 관리 서비스를 기획하게 되었습니다.",
      logo: mailAtLogo,
