...
export const PROJECTS: ProjectsType = {
  ...
  hero: {
    ...
    retrospective: [
      ...
      "또한 개발이 진행될수록 컴포넌트 구조의 복잡성과 유지보수성 문제를 실감하게 되었고, 이를 계기로 반복을 줄이고 재사용 가능한 형태로 리팩토링하는 필요성을 크게 느꼈습니다. 이후 프로젝트에서는 보다 체계적이고 유연한 컴포넌트 설계를 지향할 계획입니다.",
  ...
  portfolio: {
    ...
    retrospective: [
      ...
      "또한 성능 향상과 사용자 접근성도 중요한 고려 요소였습니다. React의 lazy loading과 코드 분할을 적용하여 초기 렌더링 속도를 개선했고, 접근성, SEO, 메타 태그 구성까지 전반적인 최적화를 진행했습니다. 그 결과 Lighthouse 100점을 달성할 수 있었습니다.",
